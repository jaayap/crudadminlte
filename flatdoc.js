...
(function($) {
   ...
   *
   * Checks to see if a LOCAL STORAGE url item has been set
   * if so, load that instead of URL defined in page.
   *
   */
  Flatdoc.checkUrl = function (url) {
