...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="' + this.applyClass + ' applyBtn btn-sm" disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;' +
                    '<button class="' + this.cancelClass + ' cancelBtn btn-sm">' + this.locale.cancelLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
        ...
        this.container.find('.calendar')
            ...
            .on('change', 'select.hourselect,select.minuteselect,select.secondselect,select.ampmselect', $.proxy(this.updateTime, this));
    ...
    DateRangePicker.prototype = {
      ...
      clickRange: function (e) {
        ...
        if (label == this.locale.customRangeLabel) {
          ...
          this.leftCalendar
            .month.month(this.startDate.month())
          ...
          this.rightCalendar
            .month.month(this.endDate.month())
      ...
      renderCalendar: function (calendar, selected, minDate, maxDate) {
        ...
        if (this.timePicker) {
          ...
          html += '<select class="secondselect input-sm">';
          for (var i = 0; i < 60; i += this.timePickerIncrement) {
            var num = i;
            if (num < 10)
              num = '0' + num;
